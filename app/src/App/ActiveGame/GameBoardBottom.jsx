  ...
  render() {
    return (
      <div className="levelDiv">
        <div
          className={`levelBar overlap ${this.props.exp === 0 ? 'hidden' : ''}`}
        ...
        <div className="overlap text_shadow marginTop5 paddingLeft5 levelTextExp">{'Exp: ' + this.props.exp + '/' + this.props.expToReach}</div>
      </div>
    );
  }
}
