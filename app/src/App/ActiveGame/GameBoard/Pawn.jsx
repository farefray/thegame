...
export default function Pawn ({ position, name, direction, idle, classList, newProps, isBoard }) {
  ...
  return <>
    ...
    <div ref={drag} style={{
      ...
      <PawnImage name={name} idle={idle} direction={direction} classList={classList} newProps={newProps} isBoard={isBoard} />
    </div>
  </>
}