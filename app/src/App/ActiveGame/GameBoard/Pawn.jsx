...
export default function Pawn ({ position, name, direction, sideLength, classList, newProps, isBoard }) {
  ...
  return <>
    ...
    <div ref={drag} style={{
      ...
      <PawnImage name={name} direction={direction} sideLength={sideLength} classList={classList} newProps={newProps} isBoard={isBoard} />
    </div>
  </>
}