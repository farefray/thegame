...
class TopBar extends Component {
  ...
  getAmountOfUnitsOnBoard = () => {
    ...
    return (
      <div className="marginTop5 flex topBarPieceDiv">
      ...
      <div className="flex topBarDiv">
        <div className="flex topBarPlayerName">
          <div className="marginTop5 biggerText text_shadow paddingLeft5">
            {this.props.visiting === this.props.index ? (
              ...
              <span>
                <span className="goldFont">{'Visit: '}</span>
                <span>{this.props.players[this.props.visiting].name}</span>
              </span>
            )}
          </div>
        </div>
        <div className="marginTop5 biggerText text_shadow topBarRound">{'Round: ' + this.props.round}</div>
        ...
        <div className="marginTop5 biggerText text_shadow topBarPadding">
          {this.props.isActiveBattleGoing ? (
            ...
            <div>
              {this.props.enemyIndex !== -1 ? (
                <span className="nextUpText">
                  {'Up next: ' + (this.props.enemyIndex !== '' ? '' : this.props.roundType === 'npc' ? 'Npc Battle' : this.props.roundType === 'pvp' ? 'PvP Battle' : '')}
                </span>
              ) : (
                ''
              )}
