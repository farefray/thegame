          ...
          <div className="marginTop5 paddingLeft5 belowShopDiv">
            <div className="flex">
              ...
              <div className={'text_shadow messageUpdate'} style={{ padding: '5px' }}>
                <div className={`updateMessage ${this.props.messageMode === 'big' ? 'goldFont' : this.props.messageMode === 'error' ? 'redFont' : ''}`}>{'Message: ' + this.props.message}</div>
              </div>
            </div>
          </div>
          <div>
            {this.props.help ? (
              <div className="text_shadow marginTop5">
